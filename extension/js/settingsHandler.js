(function(){
	...
	if(chrome.storage){
		chrome.storage.local.get(['alwaysCopyTopic', 'hideUserName', 'warnOnLosingPost','backgroundSync', 'backgroundSyncPosts', 'printAll'], function(items){
            ...
            e.setAttribute('data-print-all',items.printAll);
